    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
        ...
        @foreach($mobile as $row)        
          ...
          <a href="" target="_blank"> 
            <img src="public/images/slides/thumbs/qc2.jpg"  border="0" width="100%" height="250" />
          </a>
            ...
            <div class="thumbnail">          
              ...
              <div class="tomtat">
                <div class="thongtin">
                  ...
                  <div class="price">  
                    <span class="btn btn-info btn-block ">Giá : <strong>{!!number_format($row->price)!!}</strong> VNĐ</span>   
        ...
        <div class="clearfix">
          ...
          <a href="" target="_blank"> 
            <img src="public/images/slides/thumbs/qc1.png" border="0" width="100%" height="250" />
          </a>
<!-- =============== máy tính ===================================== -->
        <div id="pc"></div>
        @foreach($pc as $row)
