...
class PagesController extends Controller
{
    ...
    {   
    	return view ('detail.card')->with('thongbao','Chi tiết đơn hàng');
    }
    public function getoder()
    {
        if (Auth::guest()) {
            ...
            return view ('detail.oder')->with('thongbao','Xác nhận');
        }        
    }
    public function postoder(Request $rq)
    {
        ...
        Cart::destroy();   
        return redirect()->route('getcart')->with('thongbao',' Đơn hàng của bạn đã được gửi đi !');    
    ...
    public function search(Request $rq){
        $products = Products::where('name','like','%'.$rq->key.'%')->get();
