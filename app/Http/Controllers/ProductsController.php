...
class ProductsController extends Controller
{
    ...
    public function postadd(AddProductsRequest $rq)
    {
     ...
     //    die();
	   ...
	   return redirect('admin/sanpham/all')->with('thongbao','Đã thêm thành công');    	
    }
    ...
    public function postedit($loai,$id,Request $rq)
    {
    	$pro = Products::find($id);
    ...
    return redirect('admin/sanpham/mobile/edit/'.$id)
      ->with('thongbao','Đã sửa thành công');       
    }
}
